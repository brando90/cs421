...
type exp =  (* Exceptions will be added in later MPs *)
 ...
 | MonOpAppExp of mon_op * exp         (* % exp1 where % is a builtin monadic operator *)
 | BinOpAppExp of bin_op * exp * exp   (* exp1 % exp2 where % is a builtin binary operator *)
...
and exp_cps =
 ...
 | FunCPS of cps_cont * string * cont_var * exp_cps (* K (FUN x _k -> [[exp]]_k) *)
 | FixCPS of cps_cont * string * string * cont_var * exp_cps (* K (FIX f. FUN x _k -> [[exp]]_k) *)
